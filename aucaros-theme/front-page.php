   ...
   <div class="gdlr-content">
      ...
      <div class="with-sidebar-wrapper">
         <section id="content-section-1">
            <div class="gdlr-full-size-wrapper gdlr-show-all" id="home" style="padding-bottom: 0px;  background-color: #ffffff; ">
               <div class="gdlr-master-slider-item gdlr-slider-item gdlr-item" style="margin-bottom: 0px;">
                  <!-- MasterSlider -->
                  <div id="P_MS61991db553574" class="master-slider-parent ms-parent-id-4">
                     <!-- MasterSlider Main -->
                     <div id="MS61991db553574" class="master-slider ms-skin-default">
                  ...
                  <script>
                     ( window.MSReady = window.MSReady || [] ).push( function( $ ) {
                        ...
                        "use strict";
                        var masterslider_3574 = new MasterSlider();
                     
                        // slider controls
                        masterslider_3574.control('arrows'     ,{ autohide:false, overVideo:true  });
                        masterslider_3574.control('bullets'    ,{ autohide:false, overVideo:true, dir:'h', align:'bottom', space:8 , margin:20  });
                        // slider setup
                        masterslider_3574.setup("MS61991db553574", {
                           width           : 1140,
                           height          : 800,
                           minHeight       : 0,
                           space           : 0,
                        ...
                        window.masterslider_instances.push( masterslider_3574 );
                     });
                  </script>
               </div>
               <div class="clear"></div>
         ...
         <section id="content-section-2">
            <div class="gdlr-parallax-wrapper gdlr-background-image gdlr-show-all no-skin" id="discover" data-bgspeed="0" style="background-image: url(&#39;<?php echo get_template_directory_uri(); ?> /assets/images/auracos-bg.jpg&#39;); padding-top: 110px; padding-bottom: 60px; ">
               <div class="container">
         ...
         <section id="content-section-3">
            <div class="gdlr-parallax-wrapper gdlr-background-image gdlr-show-all no-skin" id="gdlr-parallax-wrapper-1" data-bgspeed="0" style="background-image: url(&#39;<?php echo get_template_directory_uri(); ?> /assets/images/border.jpg&#39;); padding-top: 2px; padding-bottom: 0px; ">
               <div class="container">
                  <div class="clear"></div>
               </div>
            </div>
         ...
         <section id="content-section-4">
            <div class="gdlr-parallax-wrapper gdlr-background-image gdlr-show-all no-skin" id="benefits" data-bgspeed="0" style="background-image: url(&#39;<?php echo get_template_directory_uri(); ?> /assets/images/bg-2-2.jpg&#39;); padding-bottom: 90px; ">
               <div class="container">
         ...
         <section id="content-section-5">
            <div class="gdlr-parallax-wrapper gdlr-background-image gdlr-show-all no-skin" id="gdlr-parallax-wrapper-2" data-bgspeed="0" style="background-image: url(&#39;<?php echo get_template_directory_uri(); ?> /assets/images/border.jpg&#39;); padding-top: 2px; padding-bottom: 0px; ">
               <div class="container">
                  <div class="clear"></div>
               </div>
            </div>
         ...
         <section id="content-section-6">
            <div class="gdlr-parallax-wrapper gdlr-background-image gdlr-show-all no-skin" id="thescience" data-bgspeed="0" style="background-image: url(&#39;<?php echo get_template_directory_uri(); ?> /assets/images/collagen-pro.jpg&#39;); ">
               <div class="container">
                  <div class="two-fifth columns">
                     <div class="gdlr-item gdlr-content-item" style="margin-bottom: 30px;"></div>
                     <div class="gdlr-image-frame-item gdlr-item" style="margin-bottom: 25px;">
                        <div class="gdlr-frame frame-type-none">
                           <div class="gdlr-image-link-shortcode"><img src="<?php echo get_template_directory_uri(); ?> /assets/images/fish-skin-e1465899042632.png" alt="" width="205" height="199" style="opacity: 0;"></div>
                        </div>
                     </div>
                     <div class="gdlr-title-item">
                        <div class="gdlr-item-title-wrapper gdlr-item pos-center ">
         ...
         <section id="content-section-7">
            <div class="gdlr-parallax-wrapper gdlr-background-image gdlr-show-all no-skin" id="gdlr-parallax-wrapper-3" data-bgspeed="0" style="background-image: url(&#39;<?php echo get_template_directory_uri(); ?> /assets/images/border.jpg&#39;); padding-top: 2px; padding-bottom: 0px; ">
               <div class="container">
                  <div class="clear"></div>
               </div>
            </div>
         ...
         <section id="content-section-8">
            <div class="gdlr-parallax-wrapper gdlr-background-image gdlr-show-all no-skin" id="gdlr-parallax-wrapper-4" data-bgspeed="0" style="background-image: url(&#39;<?php echo get_template_directory_uri(); ?> /assets/images/mowdel-3.jpg&#39;); padding-bottom: 20px; ">
               <div class="container">
                  <div class="three-fifth columns">
                     <div class="gdlr-title-item">
                        <div class="gdlr-item-title-wrapper gdlr-item pos-left ">
                     ...
                     <div class="gdlr-title-item">
                        <div class="gdlr-item-title-wrapper gdlr-item pos-left ">
                           <div class="gdlr-item-title-head">
                              <h3 class="gdlr-item-title gdlr-skin-title gdlr-skin-border">HOW DOES IT WORK?</h3>
                              <div class="clear"></div>
                           </div>
                        </div>
                     </div>
         ...
         <section id="content-section-9">
            <div class="gdlr-parallax-wrapper gdlr-background-image gdlr-show-all no-skin" id="gdlr-parallax-wrapper-5" data-bgspeed="0" style="background-image: url(&#39;<?php echo get_template_directory_uri(); ?> /assets/images/border.jpg&#39;); padding-top: 2px; padding-bottom: 0px; ">
               <div class="container">
                  <div class="clear"></div>
               </div>
            </div>
         ...
         <section id="content-section-10">
            <div class="gdlr-color-wrapper  gdlr-show-all no-skin" id="contact" style="background-color: #000000; ">
               <div class="container">
                  <div class="twelve columns">
                     <div class="gdlr-title-item">
                        <div class="gdlr-item-title-wrapper gdlr-item pos-center ">
                           <div class="gdlr-item-title-head">
                              <h3 class="gdlr-item-title gdlr-skin-title gdlr-skin-border">CONTACT</h3>
                              <div class="clear"></div>
                           </div>
                           <div class="gdlr-item-title-divider"></div>
                        </div>
                        ...
                        <div role="form" class="wpcf7" id="wpcf7-f3743-o1" lang="en-US" dir="ltr">
                           ...
                           <!-- <form action="#wpcf7-f3743-o1" method="post" class="wpcf7-form" novalidate="novalidate">
                              <div style="display: none;">
                                 ...
                                 <input type="hidden" name="_wpnonce" value="712ba518d9">
                              </div>
                              ...
                              <p>
                                 Country<br>
                                 <span class="wpcf7-form-control-wrap countrylist">
                                    <select name="countrylist" class="wpcf7-form-control wpcf7-select" aria-invalid="false">
                                       <option value="">---</option>
                              ...
                              <p>
                                 Reason of Your Enquiry<br>
                                 <span class="wpcf7-form-control-wrap reason">
                                    <select name="reason" class="wpcf7-form-control wpcf7-select" aria-invalid="false">
                                       <option value="">---</option>
                                       <option value="Purchase the product">Purchase the product</option>
