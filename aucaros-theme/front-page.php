   ...
   <div class="gdlr-content">
      ...
      <div class="with-sidebar-wrapper">
         ...
         <section id="content-section-2">
            <div class="gdlr-parallax-wrapper gdlr-background-image gdlr-show-all no-skin" id="discover" data-bgspeed="0" 
            style="background-image: url(&#39;<?php
               $image = get_field('Discover BG');
               if( !empty( $image ) ):
                  echo esc_url($image);
               endif;
         ...
         <section id="content-section-4">
            <div class="gdlr-parallax-wrapper gdlr-background-image gdlr-show-all no-skin" id="benefits" data-bgspeed="0" style="background-image: url(&#39;<?php
               $image = get_field('Benefits BG');
               if( !empty( $image ) ):
                  echo esc_url($image);
               endif;
            ?>&#39;); padding-bottom: 90px; ">
         ...
         <section id="content-section-6">
            <div class="gdlr-parallax-wrapper gdlr-background-image gdlr-show-all no-skin" id="thescience" data-bgspeed="0" style="background-image: url(&#39;<?php
               $image = get_field('The Science BG');
               if( !empty( $image ) ):
                  echo esc_url($image);
               endif;
            ?>&#39;); ">
                  ...
                  <div class="two-fifth columns">
                     ...
                     <div class="gdlr-image-frame-item gdlr-item" style="margin-bottom: 25px;">
                        <div class="gdlr-frame frame-type-none">
                           <div class="gdlr-image-link-shortcode"><img src="<?php
                              $image = get_field('The Science Avatar');
                              if( !empty( $image ) ):
                                 echo esc_url($image);
                              endif;
                           ?>" alt="" width="205" height="199" style="opacity: 0;"></div>
                        </div>
                     </div>
                     <div class="gdlr-title-item">
                        <div class="gdlr-item-title-wrapper gdlr-item pos-center ">
         ...
         <section id="content-section-8">
            <div class="gdlr-parallax-wrapper gdlr-background-image gdlr-show-all no-skin" id="gdlr-parallax-wrapper-4" data-bgspeed="0" style="background-image: url(&#39;<?php
               $image = get_field('Pro Collagenium BG');
               if( !empty( $image ) ):
                  echo esc_url($image);
               endif;
            ?>&#39;); padding-bottom: 20px; ">
         ...
         <?php if(strlen(pll__('Contact Form Title')) > 1): ?>
                     ...
                     <div class="container">
                        <div class="twelve columns">
                           <div class="gdlr-title-item">
                              <div class="gdlr-item-title-wrapper gdlr-item pos-center ">
                                 <div class="gdlr-item-title-head">
                                    <h3 class="gdlr-item-title gdlr-skin-title gdlr-skin-border"><?php pll_e('Contact Form Title'); ?></h3>
                                    <div class="clear"></div>
                                 </div>
                                 <div class="gdlr-item-title-divider"></div>
                              </div>
                           ...
                           <div class="gdlr-item gdlr-content-item">
                              <div role="form" class="wpcf7" id="wpcf7-f3743-o1" lang="en-US" dir="ltr">
                                 <div class="screen-reader-response"></div>
                                    <?php
                                       $formKey = pll__('Contact Form Key');
                                       if(strlen($formKey) > 1){
                                          echo do_shortcode("[cf7form cf7key='$formKey']");
                                       }
                                    ?>
